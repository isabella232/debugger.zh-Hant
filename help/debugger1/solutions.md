...
Analytics 標籤會提供您的 [Analytics](https://experiencecloud.adobe.com/resources/help/zh_TW/reference/) 實作相關資訊。
...
此畫面會顯示自開啟 Debugger 後或清除請求後的所有請求。預設參數會自動對映至好記名稱。如果您使用「連結 Analytics」功能 (請參閱以下所述) 進行驗證，[Prop 和 eVar](https://experiencecloud.adobe.com/resources/help/zh_TW/sc/implement/props_eVars.html) 變數可對映至自訂好記名稱 (例如「prop1」可顯示為「使用者類型」)。系統會依序由左到右顯示各項請求。
...
使用 [Audience Manager](https://experiencecloud.adobe.com/resources/help/zh_TW/aam/) 標籤檢視[事件](https://experiencecloud.adobe.com/resources/help/zh_TW/aam/dcs-event-calls.html)的詳細資料。按一下組織以將其展開並顯示資訊。
...
如需詳細資訊，請參閱 Audience Manager 產品文件中的[內送資料傳輸的 ID 同步](https://experiencecloud.adobe.com/resources/help/zh_TW/aam/c_id_sync_in.html)。
...
使用 Experience Cloud ID 服務標籤檢視 [Experience Cloud ID 服務](https://experiencecloud.adobe.com/resources/help/zh_TW/mcvid/)請求。
